...
<body>
    ...
    <div class="recipe-box">
        ...
        <div class="recipe-box-title">
            ...
            <i><?php echo htmlspecialchars($postedByName); ?></i>
        ...
        <div class="recipe-box-box">
            <div class="recipe-box-box-box">
                ...
                <div class="recipe-box-procedures" style="max-width: 200px;">
                    <b>Tags</b>
                    <?php
                        $tags = [];
        ...
        <?php
                    ...
                    echo "<p>Error executing query: " . htmlspecialchars($connect->error) . "</p>";
                }
                $stmt->close();
            } else {
